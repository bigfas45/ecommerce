...
const Orders = () => {
    ...
    const showOrdersLength = orders => {
       if (orders.length > 0 ) {
           ...
           return(
               <h1 className="text-dnager">No Orders </h1>
           )
       }
    }; 
    ...
    const handleStausChange = (e, orderId) => {
    ...
    const showStatus = (o) => (
        <div className="form-group">
            ...
            <select className="form-control" onChange={(e) => handleStausChange(e ,o._id)}>
                    ...
                    return (
                        <div className="mt-5" key={oIndex} style={{borderBottom: "5px solid indigo"}}>
                            ...
                            {o.products.map((p, pIndex) => (
                                <div className="mb-4" key={pIndex} style={{padding: '20px', border: '1px soild indigo'}}> 
